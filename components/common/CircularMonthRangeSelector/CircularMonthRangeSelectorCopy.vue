<template>
  <div class="month-picker" :style="{ '--angle': angle }" >
    ...
    <div class="month-picker--item-3">
      <div class="month-picker--item-3--el-1">{{ selectedMonth }}</div>
      <div class="month-picker--item-3--el-2">Meses</div>
    </div>
    ...
    >
      ...
      <!-- Path adicional para mejorar el estilo, dependiendo del mes -->
      <circle
        cx="50%"
        cy="50%"
...
const dots = Array.from({ length: 12 }, (_, i) => i + 1); // Representa los meses del 1 al 12
const selectedMonth = ref(3);
const angle = ref("90deg");

// Genera los valores de los paths para todos los meses
const pathValues = [
...
// Lógica para manejar el clic y actualizar el mes seleccionado
function toggleMonth(month) {
  selectedMonth.value = month;
  updateAngle(month);
}

// Función para saber si el mes está activo
function isActive(month) {
  return selectedMonth.value === month;
}

function getPath(month) {
  return pathValues[month - 1];
}

function getPathTrackBackground(month) {
  return pathTrackBackground[month - 1];
}

function getPathTrackForeground(month) {
  return pathTrackForeground[month - 1];
}

function updateAngle(month) {
  const angles = {
    1: "30deg",
    2: "60deg",
    3: "90deg",
...
.month-picker {
  ...
  position: relative;
  width: 100%;
  --circular-slider-input_height: auto;
  --circular-slider-input_width: 100%;
...
.month-picker--item-2 {
  ...
  --big-search-form_background: #ebebeb, red;
  --big-search-button_background_hover: #dddddd;
  --big-search-input-button_color: #222222;
  color: #222222;
  --big-search-form_background_active: #ebebeb;
  --query-input_flex: 1.25 0 0%;
  --input-with-search-button_flex: 1 0 0%;
  --split-date-input_flex: 1 0 0%;
  text-align: left;
  --header_brand-color: #ff385c;
  --explore_padding-inline: 40px;
  --explore-nav_padding-block-start: 20px;
  --page-shell-max-content-width: 2520px;
  --gp-sidebar-top-padding: 0;
}
...
.month-picker--item-2:after {
  ...
  --circular-slider-input_height: auto;
  --circular-slider-input_width: 100%;
  --search-input-detail-panel-transition-name: search-input-detail-panel-dates;
  --big-search-form_background: #ebebeb, red;
  --big-search-button_background_hover: #dddddd;
  --big-search-input-button_color: #222222;
  --big-search-form_background_active: #ebebeb;
...
.month-picker--item-3 {
  ...
  --input-with-search-button_flex: 1 0 0%;
  --split-date-input_flex: 1 0 0%;
  --header_brand-color: var(--ihf-tp-q);
  --explore_padding-inline: 40px;
  --explore-nav_padding-block-start: 20px;
}
...
.month-picker--item-3--el-2 {
  font-size: 12px;
  line-height: 16px;
  --monthly-stays-dial_output-value-font-size: 96px;
  --monthly-stays-dial_output-value-line-height: 89px;
